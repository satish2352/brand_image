...
<div id="contact-form" class="contact-from-section conatact-top conatact-bottom">
            ...
            <div class="col-lg-8 mb-5 mb-lg-0">
                <div class="contact-card light-card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <textarea name="remark" class="form-control" rows="5" placeholder="Requirements/Specifications" maxlength="300">{{ old('remark') }}</textarea>
    ...
    <div class="col-md-6 d-flex justify-content-center justify-content-lg-end " style="padding: 10px;">
