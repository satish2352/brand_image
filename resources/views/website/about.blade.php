            ...
            <div class="row align-items-center justify-content-center">
                ...
                <div class="col-lg-6 px-4 py-2">
                    ...
                    <p>
                        ...
                        specific needs and offer creative services that can truly make a difference.
                    </p>

                    <p>
                        With over 12 years of valuable experience in the field of Printing, Branding, Advertising, and
                    ...
                    <p>
                        At Brand Image Media Pvt Ltd, we understand the importance of creating a strong brand image for your
                        business. Through our expertise in branding, we can help you establish a distinct and memorable
                        identity that resonates with your target market. Whether it's designing logos, developing brand
                        guidelines, or creating comprehensive brand strategies, our team is dedicated to delivering
                        exceptional results.
                    </p>
                ...
                <div class="col-lg-11 py-lg-3 p-3">
                    <p>In addition to branding, we excel in various advertising mediums. From traditional print
                        advertisements to digital marketing campaigns, we stay up-to-date with the latest trends and
                        technologies to ensure maximum impact for your message. Our advertising solutions are tailored to
                        your specific goals, whether it's increasing brand awareness, driving website traffic, or generating
                        leads.
                        Furthermore, our proficiency in event management allows us to create memorable experiences that
                        leave a lasting impression. From corporate conferences to product launches, we handle every aspect
                        of event planning, ensuring seamless execution and exceptional attendee experiences.
                    </p>
                    <p>At Brand Image Media Pvt Ltd, we prioritize client satisfaction and strive to build long-lasting
                        partnerships. We believe in effective communication, collaborative teamwork, and attention to
                        detail, which are the pillars of our successful projects. We are committed to delivering results
                        that exceed your expectations and contribute to your business growth.

                        Thank you for choosing Brand Image Media Pvt Ltd as your advertising partner. We look forward to
                        working with you and helping you achieve your marketing objectives with our expertise and
                        creativity.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-center ">
                ...
                <div class="col-lg-6" data-aos="zoom-in-down">
                    ...
                    <img src="{{ asset('assets/img/45.png') }}" class="img-fluid rounded-5    d-flex justify-content-center"
                        alt="mission">
                    ...
                    <div class="row g-4 align-items-center d-grid">
                        ...
                        <div class="col-md-12">
                            <div class="mission-card">
                                <img src="{{ asset('assets/img/17.png') }}" class="img-fluid rounded-5 misiionsimg"
                                    alt="mission">
                                <div>
                                    <h5>Mission</h5>
                                    <p class="mission-desc mb-0">
                                        To help businesses achieve their marketing goals through impactful advertising by
                                        combining strategic thinking, creative ideas, and modern technology to deliver
                        ...
                        <div class="col-md-12">
                            <div class="mission-card">
                                <img src="{{ asset('assets/img/15.png') }}" class="img-fluid rounded-5 misiionsimg"
                                    alt="mission">
                                <div>
                                    <h5>Vision</h5>
                                    <p class="mission-desc mb-0">
                                        To become a trusted advertising partner by shaping powerful brand experiences
                                        through innovation, creativity, and technology while setting new standards for
                                        marketing excellence. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="mission-card">
                                <img src="{{ asset('assets/img/16.png') }}" class="img-fluid rounded-5 misiionsimg"
                                    alt="mission">
                                <div>
                                    <h5> Values</h5>
                                    <p class="mission-desc mb-0">
                                        We value innovation, creativity, and strategic thinking, delivering impactful
                                        outdoor media solutions with integrity, transparency, and a strong focus on
                                        measurable results.
                                    </p>
                                </div>
                            </div>
            ...
            <div class="row  justify-content-center">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 px-md-3 pb-5">
                    <div class="info-card orange-card h-100 w-100 ">
                        ...
                        <div class="content">
                            <img src="{{ asset('assets/img/13.png') }}" style="height: 120px; width: 120px"
                                class="mb-3" alt="">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 px-md-3 pb-5">
                    <div class="info-card orange-card h-100 w-100 ">
                        ...
                        <div class="content">
                            <img src="{{ asset('assets/img/12.png') }}" style="height: 120px; width: 120px"
                                class="mb-3" alt="">

                            <h5 class="title">Brainstorming</h5>
                            <p>Brainstorming is a general technique for coming up with an idea, but sometimes it's not good
                                enough to just sit down and tell yourself you're going to brainstorm until you get an idea.
                            </p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 px-md-3 pb-5">
                    <div class="info-card orange-card h-100 w-100">
                        ...
                        <div class="content">
                            <img src="{{ asset('assets/img/22.png') }}" style="height: 120px; width: 120px"
                                class="mb-3" alt="">

                            <h5 class="title">Present</h5>
                            <p>Discuss the common demographics of the market, where people shop and how they spend, all of
                                which you will use to justify your creative ideas.</p>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 px-md-3 pb-5">
                    <div class="info-card orange-card h-100 w-100">
                        <div class="content">
                            <img src="{{ asset('assets/img/11.png') }}" style="height: 120px; width: 120px"
                                class="mb-3" alt="">
