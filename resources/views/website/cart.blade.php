                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="cart-info mt-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mb-2"> : {{ number_format($width, 2) }} x
                                {{ number_format($height, 2) }} ft
                            </div>
                            ...
                            <div class="col-6 mb-2"> ₹ {{ number_format($item->per_day_price, 2) }} / day
                            </div>
                        </div>
                ...
                flatpickr(calendar, {
                    ...
                    onReady: function(selectedDates, dateStr, fp) {
                        if (selectedDates.length === 2) {
                            ...
                            checkAllDatesSelected();   // ⭐ ADD THIS
                        }
                    },
                    ...
                    onChange: function(dates, dateStr, fp) {
                        ...
                        checkAllDatesSelected();   // ⭐ ADD THIS LINE
