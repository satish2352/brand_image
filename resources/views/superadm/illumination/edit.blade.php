        ...
        <div class="col-lg-6 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <h4 class="mb-4">Edit Illumination</h4>
                    ...
                    <form action="{{ route('illumination.update', $encodedId) }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="illumination_name"
                                ...
                                value="{{ old('illumination_name', $illumination->illumination_name) }}">
