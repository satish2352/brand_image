        ...
        <div class="col-lg-6 mx-auto">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('highway.update', $encodedId) }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="highway_name"
                                ...
                                value="{{ old('highway_name', $highway->highway_name) }}">
                            @error('highway_name')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="highway_type"
                                ...
                                @foreach (['National', 'State', 'Expressway', 'Other'] as $type)
                                    <option value="{{ $type }}"
                                        {{ old('highway_type', $highway->highway_type) == $type ? 'selected' : '' }}>
                                        {{ $type }}
                                    </option>
                                @endforeach
                            </select>
